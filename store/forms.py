...
class SignUpForm(UserCreationForm):
	email = forms.EmailField(label="",max_length=200, widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Email Address'}))
...
class UpdateUserForm(UserChangeForm):
	#hide password messange
	password = None
	#user information
	email = forms.EmailField(label="Email ",max_length=200, widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Email Address'}))
	...
	def __init__(self, *args, **kwargs):
		...
		# self.fields['username'].widget.attrs['style'] = 'display: inline-block; width: 70%; margin-left: 10px;'
...
class UserInfoForm(forms.ModelForm):
	...
	address1 = forms.CharField(label="Your Address 1 ", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Address 1'}), required=False)
	address2 = forms.CharField(label="Your Address 2", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Address 2'}), required=False)
